...
<%session.setAttribute("user", "小花");%>
<script type="text/javascript">
var ws = null;
function startWebSocket() {
    if ('WebSocket' in window)
        ws = new WebSocket("ws://localhost:8080/WebChat/mywebsocket.do");
    else if ('MozWebSocket' in window)
        ws = new MozWebSocket("ws://localhost:8080/WebChat/mywebsocket.do");
    else
        alert("not support");
    ...
    ws.onopen = function(evt) {
        ...
        document.getElementById('userName').innerHTML="小花";
    };
}
